...
export default function Linking({user}) {
  ...
  return <div><div className="page-heading"><div><p className="eyebrow">IDENTITY BRIDGE</p><h1>Account linking</h1><p>Connect this Discord account to your in-game Shadow RP identity.</p></div></div>
    <div className="link-grid"><section className="panel instructions"><h2><Gamepad2/> In-game steps</h2><ol><li>Join the Shadow RP Reforger server.</li><li>Your first join automatically shows a code at the top of the screen.</li><li>Copy the six-character code and enter it here within ten minutes.</li><li>If it expired, use the account-link terminal once to issue a replacement.</li></ol><div className="linked-state"><span>Current Reforger UID</span><strong>{user.reforger_uid||'Not linked'}</strong></div></section>
